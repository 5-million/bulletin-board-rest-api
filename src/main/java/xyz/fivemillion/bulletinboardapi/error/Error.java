...
public enum Error {
    ...
    CATEGORY_DUPLICATE("이미 존재하는 카테고리입니다.", "이미 존재하는 카테고리"),
    ...
    UNKNOWN_CATEGORY("등록되지 않은 카테고리입니다.", "등록되지 않은 카테고리에 대한 요청"),
    USER_NOT_FOUND("사용자를 찾을 수 없습니다.", "등록되지 않은 사용자"),
    POST_NOT_FOUND("포스트를 찾을 수 없습니다.", "등록되지 않은 포스트"),
    CATEGORY_NOT_FOUND("카테고리를 찾을 수 없습니다.", "등록되지 않은 카테고리"),
    ...
    ARGUMENT_IS_NULL("argument는 null이 아니어야 합니다.", "argument == null"),
